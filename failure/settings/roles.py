...
Please refer to the wiki page for more information on roles/permissions and
details regarding the roll-out procedure:

https://github.com/Radico/web/wiki/Permissions
